...
Result: The mirror has now completely returned to normal, completely empty, only reflecting the opposite wall. The protagonist scratches her head in confusion, showing a life-questioning expression toward the camera. The frame freezes on the protagonist's confused face (comedy effect).`,
  ...
  },
  {
    ...
    title: `1. Figure 1 vs Figure 2 Martial Arts Tournament`,
    description: `World martial arts tournament battle between two figures with input image.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `2. Nezha and Ao Bing Ice-Fire Clash (Space-Time Folding)`,
    description: `Testing dynamic consistency and motion transitions with high-frequency, large-scale actions.`,
...
Visual Focus: Testing Seedance 2.0's logical continuity using particle continuity.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `3. Otter Mecha Anime Battle (Mech vs. Octopus)`,
    description: `Anime scene with mechanical parts, otter piloting a mech, and battle against a marble octopus.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `6. Motion Graphics`,
    description: `Creating motion graphics animation using 3D animation style.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `5. Van Gogh Post-Impressionism Style Animation`,
    description: `Dreamy animated world created with thick oil paint textures and swirling brushstrokes.`,
...
Background: A sleeping town in the valley, windows of houses emit warm, circularly painted yellow light. The entire scene slowly flows and breathes following the direction of brushstrokes.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `6. Tournament of Power with Famous Anime Characters`,
    description: `Epic anime battle scene with multiple characters from different series in a cosmic arena.`,
...
Comedy and catastrophe collide.`,
  ...
  {
    category: `Anime & Animation Styles`,
    title: `7. Luffy Coding on MacBook (Comedy Scene)`,
    description: `Funny scene of anime character Luffy getting frustrated with coding and throwing the laptop overboard.`,
