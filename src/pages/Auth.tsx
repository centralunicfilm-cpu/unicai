          ...
          <div className="mt-5 flex flex-col gap-2 text-center">
            {mode === "login" && (
              <>
                ...
                <button onClick={() => { setMode("signup"); setMessage(null); }} className="text-xs text-[hsl(var(--text-secondary))] hover:text-orange transition-colors">
                  {hasLocalAccount ? "Conta local criada neste Mac" : <>Primeiro acesso? <span className="text-orange">Criar senha local</span></>}
                </button>
              </>
            )}
            {mode !== "login" && (
